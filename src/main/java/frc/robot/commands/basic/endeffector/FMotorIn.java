...
public class FMotorIn extends Command {
  EndEffectorSubsystem endEffectorSubsystem;

  /** Creates a new FMotorIn. */
  public FMotorIn(EndEffectorSubsystem m_endEffectorSubsystem) {
  ...
  @Override
  public void execute() {
    endEffectorSubsystem.spinFMotor(fMotorInSpeed);
  }
